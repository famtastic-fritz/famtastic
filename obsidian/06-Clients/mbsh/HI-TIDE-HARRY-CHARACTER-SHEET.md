...
Hi-Tide Harry is a heroic mascot character for Miami Beach Senior High. Sonic-influenced energy, but with **his own** silhouette: pointed ears, swept quiff, silver cape, school colors. He is the visual ambassador for the school's spirit, the chatbot persona for the reunion site, and the canonical Hi-Tide Harry going forward.
...
Sonic-influenced cartoon hero, but with his own design: pointed elf-like
...
Original mascot character, NOT Sonic the Hedgehog, NOT existing IP.
```

### Negative prompt elements
```
NOT: photorealistic, 3D rendered, Pixar style, anime shading, blue color,
yellow color, hedgehog spikes, animal mascot, Sonic the Hedgehog,
...
7. **Character is original, NOT Sonic** — call out explicitly in every prompt
