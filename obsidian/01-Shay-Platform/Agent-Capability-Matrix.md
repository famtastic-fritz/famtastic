...
| **Built-in MEMORY.md / USER.md** | Curated agent memory | ✅ Available | live_verified | current runtime injects MEMORY/USER profile surfaces, and the 2026-06-18 spillover repair now auto-routes bulky writes to off-prompt ledgers instead of failing on prompt-memory saturation | Free | Durable user preferences, environment facts, and compact always-loaded pointer context without treating prompt memory like bulk storage | Built into Hermes |
