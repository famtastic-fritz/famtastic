...
**Last updated:** 2026-06-23 (Added `shay intelligence trace <ask>`, expanded the ask-intent registry, aligned HyperSwarm internal-lane truth, and repaired live identity-guard drift on USER.md so trace runs stop surfacing false authority alarms.)
