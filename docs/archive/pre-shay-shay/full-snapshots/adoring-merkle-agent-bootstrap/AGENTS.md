...
## Commit Policy
- NEVER include "Codex", "AI", "Co-Authored-By", "generated", "assisted", or any AI-related references in commit messages, commit bodies, or commit metadata.
...
- **One repo:** `~/famtastic/` — the consolidated home for everything
  ...
  - Multi-agent workflow: `fam-hub agent *` (Codex, Gemini, Codex adapters + conversation reconciliation)
...
way the project owner keeps Codex Web sessions informed about the current
state of the codebase. It lives in the Codex Web project folder, outside
