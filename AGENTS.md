...
discussion and restate it as a work packet before proceeding. Minimum packet
fields:
...
Use `fam-hub plan template` for the canonical shape and `fam-hub plan validate`
to enforce it against plan.json files.
